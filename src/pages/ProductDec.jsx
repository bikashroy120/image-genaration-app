...
const CreactPost = () => {
    ...
    const handleSurpriseMe = () => {
        const randomPrompt = getRandomPromptProduct(form.prompt);
    ...
    const handleSubmit = async (e) => {
      ...
      if (form.prompt) {
        setLoading(true)
        axios.post("http://localhost:8080/api/v1/dalle/product-dec",{prompt: form.prompt})
        .then((res)=>{
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        <h1 className="font-extrabold text-[#222328] text-[32px]">Ad from product description</h1>
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">Turn a product description into ad copy.</p>
      </div>
